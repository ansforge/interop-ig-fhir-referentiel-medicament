...
<strong>⚙️ Contenu technique</strong> – Cette page s'adresse aux développeurs et intégrateurs. Elle décrit la structure du CodeSystem RUIM et les propriétés utilisées pour caractériser chaque médicament.
</div>
