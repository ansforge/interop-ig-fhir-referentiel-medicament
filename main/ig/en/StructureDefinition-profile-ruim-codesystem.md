...
* Examples for this Profile: [CodeSystem/MinimalRuim](CodeSystem-MinimalRuim.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.ruim|current/StructureDefinition/StructureDefinition-profile-ruim-codesystem.json)
